...
func TestValidReplacesChain(t *testing.T) {
	...
	specs := []spec{
		...
		},
		{
			...
			ch: Channel{Bundles: map[string]*Bundle{
				"anakin.v0.0.4": {Name: "anakin.v0.0.4", Skips: []string{"anakin.v0.0.4"}},
				"anakin.v0.0.5": {Name: "anakin.v0.0.5", Replaces: "anakin.v0.0.4"},
			}},
			assertion: hasError(`anakin.v0.0.4 -> anakin.v0.0.4`),
		},
		...
		},
		{
			...
			ch: Channel{Bundles: map[string]*Bundle{
				"anakin.v0.0.1": {Name: "anakin.v0.0.1", Skips: []string{"anakin.v0.0.3"}},
		...
		},
		{
			...
			ch: Channel{Bundles: map[string]*Bundle{
				"anakin.v0.0.5": {Name: "anakin.v0.0.5", Skips: []string{"anakin.v0.0.7"}},
				"anakin.v0.0.6": {Name: "anakin.v0.0.6", Skips: []string{"anakin.v0.0.5"}},
				"anakin.v0.0.7": {Name: "anakin.v0.0.7", Skips: []string{"anakin.v0.0.6"}},
				"anakin.v0.0.8": {Name: "anakin.v0.0.8", Skips: []string{"anakin.v0.0.7"}},
			}},
		...
		},
		{
			...
			ch: Channel{Bundles: map[string]*Bundle{
				"anakin.v0.0.1": {Name: "anakin.v0.0.1"},
				"anakin.v0.0.2": {Name: "anakin.v0.0.2", Replaces: "anakin.v0.0.1", Skips: []string{"anakin.v0.0.4"}},
				"anakin.v0.0.3": {Name: "anakin.v0.0.3", Replaces: "anakin.v0.0.2"},
				"anakin.v0.0.4": {Name: "anakin.v0.0.4", Replaces: "anakin.v0.0.3"},
				"anakin.v0.0.5": {Name: "anakin.v0.0.5", Replaces: "anakin.v0.0.4", Skips: []string{"anakin.v0.0.7"}},
				"anakin.v0.0.6": {Name: "anakin.v0.0.6", Replaces: "anakin.v0.0.5"},
				"anakin.v0.0.7": {Name: "anakin.v0.0.7", Replaces: "anakin.v0.0.6"},
				"anakin.v0.0.8": {Name: "anakin.v0.0.8", Replaces: "anakin.v0.0.7"},
			}},
		...
		},
		{
			...
			ch: Channel{Bundles: map[string]*Bundle{
				...
				"anakin.v0.0.2": {Name: "anakin.v0.0.2", Replaces: "anakin.v0.0.1"},
				"anakin.v0.0.3": {Name: "anakin.v0.0.3", Replaces: "anakin.v0.0.2"},
				"anakin.v0.0.4": {Name: "anakin.v0.0.4", Replaces: "anakin.v0.0.3", Skips: []string{"anakin.v0.0.2"}},
