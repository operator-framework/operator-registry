...
require (
	...
	// We were previously on a fork for an issue where the prod registry proxy returns a 403 on post, see https://github.com/containerd/containerd/pull/4983
	// Pinning back to upstream, but leaving this breadcrumb in case the proxy still has this issue.
