...
const (
	...
	Registry_GetCustomSchemas_FullMethodName                   = "/api.Registry/GetCustomSchemas"
)
...
type RegistryClient interface {
	...
	GetCustomSchemas(ctx context.Context, in *GetCustomSchemasRequest, opts ...grpc.CallOption) (Registry_GetCustomSchemasClient, error)
}
...
func (c *registryClient) ListPackages(ctx context.Context, in *ListPackageRequest, opts ...grpc.CallOption) (Registry_ListPackagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Registry_ServiceDesc.Streams[0], Registry_ListPackages_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *registryClient) GetPackage(ctx context.Context, in *GetPackageRequest, opts ...grpc.CallOption) (*Package, error) {
	out := new(Package)
	err := c.cc.Invoke(ctx, Registry_GetPackage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) GetBundle(ctx context.Context, in *GetBundleRequest, opts ...grpc.CallOption) (*Bundle, error) {
	out := new(Bundle)
	err := c.cc.Invoke(ctx, Registry_GetBundle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) GetBundleForChannel(ctx context.Context, in *GetBundleInChannelRequest, opts ...grpc.CallOption) (*Bundle, error) {
	out := new(Bundle)
	err := c.cc.Invoke(ctx, Registry_GetBundleForChannel_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) GetChannelEntriesThatReplace(ctx context.Context, in *GetAllReplacementsRequest, opts ...grpc.CallOption) (Registry_GetChannelEntriesThatReplaceClient, error) {
	stream, err := c.cc.NewStream(ctx, &Registry_ServiceDesc.Streams[1], Registry_GetChannelEntriesThatReplace_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *registryClient) GetBundleThatReplaces(ctx context.Context, in *GetReplacementRequest, opts ...grpc.CallOption) (*Bundle, error) {
	out := new(Bundle)
	err := c.cc.Invoke(ctx, Registry_GetBundleThatReplaces_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) GetChannelEntriesThatProvide(ctx context.Context, in *GetAllProvidersRequest, opts ...grpc.CallOption) (Registry_GetChannelEntriesThatProvideClient, error) {
	stream, err := c.cc.NewStream(ctx, &Registry_ServiceDesc.Streams[2], Registry_GetChannelEntriesThatProvide_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *registryClient) GetLatestChannelEntriesThatProvide(ctx context.Context, in *GetLatestProvidersRequest, opts ...grpc.CallOption) (Registry_GetLatestChannelEntriesThatProvideClient, error) {
	stream, err := c.cc.NewStream(ctx, &Registry_ServiceDesc.Streams[3], Registry_GetLatestChannelEntriesThatProvide_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *registryClient) GetDefaultBundleThatProvides(ctx context.Context, in *GetDefaultProviderRequest, opts ...grpc.CallOption) (*Bundle, error) {
	out := new(Bundle)
	err := c.cc.Invoke(ctx, Registry_GetDefaultBundleThatProvides_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) ListBundles(ctx context.Context, in *ListBundlesRequest, opts ...grpc.CallOption) (Registry_ListBundlesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Registry_ServiceDesc.Streams[4], Registry_ListBundles_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *registryClient) GetCustomSchemas(ctx context.Context, in *GetCustomSchemasRequest, opts ...grpc.CallOption) (Registry_GetCustomSchemasClient, error) {
	stream, err := c.cc.NewStream(ctx, &Registry_ServiceDesc.Streams[5], Registry_GetCustomSchemas_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &registryGetCustomSchemasClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Registry_GetCustomSchemasClient interface {
	Recv() (*structpb.Struct, error)
	grpc.ClientStream
}

type registryGetCustomSchemasClient struct {
	grpc.ClientStream
}

func (x *registryGetCustomSchemasClient) Recv() (*structpb.Struct, error) {
...
type RegistryServer interface {
	...
	GetCustomSchemas(*GetCustomSchemasRequest, Registry_GetCustomSchemasServer) error
...
func (UnimplementedRegistryServer) GetCustomSchemas(*GetCustomSchemasRequest, Registry_GetCustomSchemasServer) error {
	return status.Errorf(codes.Unimplemented, "method GetCustomSchemas not implemented")
}
...
func _Registry_GetCustomSchemas_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetCustomSchemasRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(RegistryServer).GetCustomSchemas(m, &registryGetCustomSchemasServer{stream})
}

type Registry_GetCustomSchemasServer interface {
	Send(*structpb.Struct) error
	grpc.ServerStream
}

type registryGetCustomSchemasServer struct {
	grpc.ServerStream
}

func (x *registryGetCustomSchemasServer) Send(m *structpb.Struct) error {
	return x.ServerStream.SendMsg(m)
}
...
var Registry_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetCustomSchemas",
			Handler:       _Registry_GetCustomSchemas_Handler,
			ServerStreams: true,
		},
	},
