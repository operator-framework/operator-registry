...
type GetCustomSchemasRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetCustomSchemasRequest) Reset() {
	*x = GetCustomSchemasRequest{}
	mi := &file_registry_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetCustomSchemasRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCustomSchemasRequest) ProtoMessage() {}

func (x *GetCustomSchemasRequest) ProtoReflect() protoreflect.Message {
	mi := &file_registry_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCustomSchemasRequest.ProtoReflect.Descriptor instead.
func (*GetCustomSchemasRequest) Descriptor() ([]byte, []int) {
	return file_registry_proto_rawDescGZIP(), []int{19}
}

func (x *GetCustomSchemasRequest) GetSchema() string {
	if x != nil {
		return x.Schema
	}
	return ""
...
func (x *GetCustomSchemasRequest) GetPackageName() string {
	if x != nil {
		return x.PackageName
	}
	return ""
...
func (x *GetCustomSchemasRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
const file_registry_proto_rawDesc = "" +
	...
	"\x17GetCustomSchemasRequest\x12\x16\n" +
	"\x06schema\x18\x01 \x01(\tR\x06schema\x12 \n" +
	"\vpackageName\x18\x02 \x01(\tR\vpackageName\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name2\x9e\x06\n" +
	"\bRegistry\x12=\n" +
	...
	"\vListBundles\x12\x17.api.ListBundlesRequest\x1a\v.api.Bundle\"\x000\x01\x12M\n" +
	"\x10GetCustomSchemas\x12\x1c.api.GetCustomSchemasRequest\x1a\x17.google.protobuf.Struct\"\x000\x01B\aZ\x05.;apib\x06proto3"
...
var file_registry_proto_goTypes = []any{
	...
	(*GetCustomSchemasRequest)(nil),   // 19: api.GetCustomSchemasRequest
...
var file_registry_proto_depIdxs = []int32{
	...
	19, // 18: api.Registry.GetCustomSchemas:input_type -> api.GetCustomSchemasRequest
	...
	20, // 29: api.Registry.GetCustomSchemas:output_type -> google.protobuf.Struct
