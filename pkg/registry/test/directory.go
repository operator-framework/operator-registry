...
func ContentQueriable(t *testing.T, querier registry.Query) {
	...
	t.Run("get bundle that replaces in channel", func(t *testing.T) {
	...
	t.Run("get channel entries that provide", func(t *testing.T) {
	...
	t.Run("get latest channel entries that provide", func(t *testing.T) {
	...
	t.Run("get bundle that provides", func(t *testing.T) {
	...
	t.Run("get related images", func(t *testing.T) {
